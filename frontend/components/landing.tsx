...
const LandingComponent = () => {
  ...
  return (
    <div className="h-dvh flex flex-col   bg-[#212121] ">
      <div className="overflow-y-scroll mt-5 scroll-smooth h-full ">
        <AnimatePresence >
          <div className="flex pb-5 px-4  flex-col w-full lg:w-[80%] h-full mx-auto">
            {responses.length === 0 && (
              <motion.div
      ...
      >
        <Input
          className="flex-1 h-16 rounded-full pt-6 px-6 bg-[#303030] p-5 shadow-sm focus-visible:ring-2 focus-visible:ring-primary/50"
